...
router.use("/", async (req, res) => {
  ...
  const valueArray = [memberSid,shopSid,shopMemo,deliverMemo,order_total,coupon_sid,saled,0,0,0,daily_coupon_sid,cook_time,total_amount,receiveName,receivePhone,sendAddress]
